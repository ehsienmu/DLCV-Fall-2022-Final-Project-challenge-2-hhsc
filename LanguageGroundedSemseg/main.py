...
def main():
    ...
    logging.info('===> Initializing dataloader {}'.format(DatasetClass))
    ...
    logging.info("checkpoint_callbacks")
    ...
    print("Set wandb project attributes")
    wandb_id = randStr()
    version_num = 0
    if config.resume:
    ...
    # print("TrainerModule",model, config, data_loader.dataset)

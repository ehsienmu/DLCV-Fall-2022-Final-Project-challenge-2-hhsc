...
# Loss params
opt_arg.add_argument('--loss_type', type=str, default='focal')  # cross_entropy, focal, weighted_ce
...
data_arg.add_argument('--effective_batch_size', type=int, default=1)
data_arg.add_argument('--cache_data', type=str2bool, default=False)
data_arg.add_argument('--num_workers', type=int, default=0, help='num workers for train dataloader')
...
data_aug_arg.add_argument('--instance_augmentation', type=str, default=None, help='For applying targeted augmentation of less frequent categories. [raw, latent] for [pointcloud, latent space] augmentation') #raw

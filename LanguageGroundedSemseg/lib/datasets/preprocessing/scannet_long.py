...
SCANNET_RAW_PATH = Path('/home/pywu/chiawen/DLCV/project/dataset')
SCANNET_OUT_PATH = Path('/home/pywu/chiawen/DLCV/project/dataset')
...
# print("train_scenes_file",train_scenes_file)
train_scenes_file = open(SCANNET_RAW_PATH / "train.txt", 'r')
print("train_scenes_file",train_scenes_file)
...
for i, line in enumerate(train_scenes):
    ...
    print("train_scenes[i]",train_scenes[i])
test_scenes_file = open(SCANNET_RAW_PATH / 'test.txt', 'r')
...
print("train_pc_files",train_pc_files)
